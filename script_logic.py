...
class StepikReset:
    ...
    def progress_reset(self) -> None:
        with webdriver.Chrome(service=ChromiumService(ChromeDriverManager().install()), options=self.options) as driver:
            ...
            '''поиск нужного курса'''
            WebDriverWait(driver, 60).until(EC.element_to_be_clickable((By.ID, 'ember19'))).click()
